    ...
    <div class="registerCon">
        ...
        <ul class="projectTypeList clearfix">
            <li class="projectTypeItem">
                <a class="" href="publishingProjectStep01.do?projectType=培训讲座" onClick="return checklogin();" target="_self">
                    <i class="icon"></i>
                    <h3>培训讲座</h3>
                </a>
            </li>
            <li class="projectTypeItem">
                <a class="" href="publishingProjectStep01.do?projectType=应用软件" onClick="return checklogin();" target="_self">
                    <i class="icon"></i>
                    <h3>应用软件</h3>
                </a>
            </li>
            <li class="projectTypeItem">
                <a class="" href="publishingProjectStep01.do?projectType=算法研究" onClick="return checklogin();" target="_self">
                    <i class="icon"></i>
                    <h3>算法研究</h3>
                </a>
            </li>
