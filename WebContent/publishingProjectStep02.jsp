		...
		<div class="container">
			...
			<div class="<!--collapse--> navbar-collapse"
                ...
                -->
					...
					<li class="floatLelt"><a href="" id="toPublishProject" class="active">发布项目</a></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
	...
	<div class="container">
		...
		<div class="registerCon">
			...
			<form id="pubStepForm02"
				action="<%=basePath%>publishingProjectStep02.do" method="post"
				...
				<ul class="projectInfList">
					...
					<li class="projectInfListItem projectTime clearfix"><label
						...
						id="" class="form-control">
							...
							<option value="6个月" selected="selected">6个月</option>
					...
					<li class="projectInfListItem addTitleList">
						...
						<label class="errorTip"><span class="arrow"></span>请添加项目详情</label>
					...
					<li class="projectInfListItem projectNav"><a
						href="publishingProjectUpdateProjectType.jsp" class="prevStep"
...
<script>
	$(function() {
		...
		//动态表单
        //验证项目详情必填
        function valiTagsInfoNum(){
            if($('.TagInfo').length <= 0){
                $('#addTagsWraper').siblings('.errorTip').show();
                swich =  false;
            }else {

                $('#addTagsWraper').siblings('.errorTip').hide();
                swich =  true;
            }
            totalSwichArr[8] = swich;
		...
		$('button[type = "submit"]').click(
				function(e) {
					...
					var valiFunArr = [ 'valiAutoCompleteInput',
							...
							'valiupLoadDataSetFieldInput','valiTagsInfoNum' ];
