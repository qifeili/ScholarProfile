...
public class BaiduTranslate {
	...
	private static final String appId = "20160315000015593";

	//申请成功后的证书token，实际使用时请修改成开发者自己的token
	private static final String token = "CjgcVkR8qgssr3OWHXkQ";
	...
	public String zh2en(String query) throws Exception {
		String result = translate(query, "zh", "en");
		return result;
	}
	
	public String en2zh(String query) throws Exception{
		String result = translate(query, "en", "zh");
		return result;
	}
	
	public String toen(String query) throws Exception {
		String result = translate(query, "auto", "en");
		return result;
	}
	
	public String tozh(String query) throws Exception{
		String result = translate(query, "auto", "zh");
		return result;
	}
...
//	}
	...
	public static void main(String[] args) {
		...
		String dest = null;
		try {
			dest = new BaiduTranslate().translate(src, from, to);
		} catch (Exception e) {
